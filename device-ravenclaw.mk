...
include device/google/cheetah/audio/ravenclaw/audio-tables.mk
...
# Init files
PRODUCT_COPY_FILES += \
	device/google/cheetah/conf/init.ravenclaw.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.ravenclaw.rc

# Recovery files
PRODUCT_COPY_FILES += \
        device/google/cheetah/conf/init.recovery.device.rc:$(TARGET_COPY_OUT_RECOVERY)/root/init.recovery.ravenclaw.rc

# insmod files
PRODUCT_COPY_FILES += \
	device/google/cheetah/init.insmod.ravenclaw.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/init.insmod.ravenclaw.cfg

# Camera
PRODUCT_COPY_FILES += \
	device/google/cheetah/media_profiles_ravenclaw.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_V1_0.xml
...
# Thermal Config
PRODUCT_COPY_FILES += \
	device/google/cheetah/thermal_info_config_ravenclaw.json:$(TARGET_COPY_OUT_VENDOR)/etc/thermal_info_config.json \
	device/google/cheetah/thermal_info_config_proto.json:$(TARGET_COPY_OUT_VENDOR)/etc/thermal_info_config_proto.json

# Power HAL config
PRODUCT_COPY_FILES += \
	device/google/cheetah/powerhint-ravenclaw.json:$(TARGET_COPY_OUT_VENDOR)/etc/powerhint.json
...
# PowerStats HAL
PRODUCT_SOONG_NAMESPACES += \
    device/google/cheetah/powerstats/ravenclaw
